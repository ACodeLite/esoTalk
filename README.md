...
esoTalk has only been tested on **Apache** and **lighttpd**. If you encounter a problem specific to any other web server, please [create an issue](https://github.com/ACodeLite/esoTalk/issues).

### Installation

Installing esoTalk is super easy. In brief, simply:

1. [Download esoTalk.](https://github.com/ACodeLite/esoTalk/archive/master.zip)
...
1. [Download](https://github.com/ACodeLite/esoTalk/archive/master.zip) the latest version of esoTalk.
...
If you are having problems installing esoTalk, view the [Troubleshooting](https://github.com/ACodeLite/esoTalk/wiki) documentation.
